...
export function CreativeCalendarPage() {
  const allEvents = useScopedCalendarEvents('criativo')
  ...
  return (
    <div>
      <SectionHeader
        ...
        description="Tarefas criativas, postagens, reels, carrosséis, stories, revisões e aprovações."
      />
