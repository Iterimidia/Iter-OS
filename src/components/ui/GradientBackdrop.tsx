...
export function GradientBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden bg-iter-bg">
      ...
      <div className="absolute -left-32 -top-32 h-96 w-96 rounded-full bg-iter-primary/10 blur-[120px]" />
      <div className="absolute -bottom-32 -right-16 h-96 w-96 rounded-full bg-iter-tertiary/10 blur-[120px]" />
      <div
